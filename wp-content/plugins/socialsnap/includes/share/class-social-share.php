					...
					<div class="ss-popup-networks ss-clearfix">
						<?php foreach ( $all_networks as $id => $name ) { 
							...
							<div class="ss-popup-network ss-popup-<?php echo esc_attr( $id ); ?>">
								<a href="#" data-ss-ss-link="<?php echo $share_url; ?>" data-id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $icon_class ); ?>" <?php echo $additional_data; ?> rel="nofollow">
			...
			foreach ( $data['options']['networks'] as $network => $network_settings ) { 
				...
				<li class="<?php echo $hide_class; ?>">
					...
					<?php } else { ?>
						...
						<a href="#" data-ss-ss-link="<?php echo $share_url; ?>" class="<?php echo esc_attr( $icon_class ); ?>" rel="nofollow" <?php echo $additional_data; ?>>
					<?php } ?>
