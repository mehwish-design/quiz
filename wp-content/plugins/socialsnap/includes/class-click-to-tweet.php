...
class SocialSnap_Click_To_Tweet {
	...
	public function register_shortcodes( $atts ) {
		...
		<div class="ss-ctt-wrapper ss-ctt-style-<?php echo $ctt['style'] . $ctt['hide_on_mobile']; ?>" data-ss-post-id="<?php the_ID(); ?>" data-nonce="<?php echo wp_create_nonce( 'socialsnap-ctt-add-to-db' ); ?>">
			...
			<a href="<?php echo $tweet_url; ?>" class="ss-ctt-tweet" data-title="<?php _e( 'Click to Tweet', 'socialsnap' ); ?>" rel="nofollow" target="_blank"><?php echo $ctt['content']; ?></a>

			<a href="<?php echo $tweet_url; ?>" class="ss-ctt-link" data-title="<?php _e( 'Click to Tweet', 'socialsnap' ); ?>" rel="nofollow" target="_blank">
