...
class SocialSnap_Post_List_Table {
	...
	*/
	...
	function quick_edit_javascript() {
		...
		function socialsnap_checked_disable_share( fieldValue ) {
			inlineEditPost.revert();
			jQuery( '.ss_social_share_disable' ).attr( 'checked', 0 == fieldValue ? false : true );
		}
		</script>
		<?php
	}
	...
	function expand_quick_edit_link( $actions, $post ) {
		...
		$actions['inline hide-if-no-js'] .= " onclick=\"socialsnap_checked_disable_share('{$data}')\" >";
